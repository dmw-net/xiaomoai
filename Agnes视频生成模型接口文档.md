...
准备工作
开始接入前，请确保你已经具备以下条件：
已获得有效的 Agnes AI API Key。
当前网络环境可以访问 Agnes AI API Gateway。
已确认模型名称：agnes-video-v2.0。
已准备好视频生成所需的文本提示词。
如需使用图生视频、多图视频或关键帧动画，请准备可公网访问的图片 URL。
API Endpoints
创建视频任务
项目
说明
...
string
本字段为最终生成的视频 URL，仅在 status 为 completed 时可用
error
object / null
错误信息，任务失败时返回
任务状态说明
...
更长视频
增加 num_frames 或降低 frame_rate
更平滑运动
使用 frame_rate: 24 或 30
可复现结果
设置固定 seed
关键帧过渡
